...
- 有效单位参考列表：`mm / cm / inch / in / ft / oz / lb / kg / g / ml / L / mAh / W / V / Hz / kHz / dB / °F / °C`（含数字才算，裸单位不计）
...
**审计标准**：
- 字段长度：title 和每条 bullet 是否在建议范围内？（逐条列出超出/不足的字段）
...
**评分标准**：
- 9–10：自然可读，长度合规，信息量足，零堆砌
- 7–8：整体自然，有 1–2 处长度偏差或轻微不顺畅
- 5–6：明显关键词插入但仍可读，或多条 bullet 长度不达标
- 3–4：关键词为主，句子碎片化，长度普遍不合规
- 0–2：纯关键词堆砌
